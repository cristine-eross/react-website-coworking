...
function Hero({ line1, strong1, line2, line3, strong2, cta }) {
  return (
    <div className='w-full max-h-[800px]'>
        <div className='border bg-hero_image_mobile h-[800px] lg:bg-hero_image max-h-full lg:h-[600px] bg-no-repeat bg-cover lg:mb-[300px]'>
          <div className=' bg-gray-100 shadow-xl shadow-slate-900 w-5/6 mx-auto my-[550px] flex flex-col justify-center items-center text-center py-10'>
        ...
        <div className='bg-slate-300 w-[280px] h-[90px] z-0 flex justify-center items-center mt-[-50px] mx-auto'>
